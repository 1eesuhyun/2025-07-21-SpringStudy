	...
	<div class="container-fluid" id="type_app">
		<div class="row">
			<div class="text-center">
				...
				<button class="btn-lg btn-info" type=button @click="select('일식')">일식</button>
				<button class="btn-lg btn-warning" type=button @click="select('양식')">양식</button>
			...
			<div class="col-sm-7" style="margin-top: 20px">
				<div class="col-md-3" v-for="vo in list">
					<div class="thumbnail">
						...
						<img :src="vo.poster" style="width: 180px; height: 120px">
							<div class="caption">
								<p>{{vo.name}}</p>
							</div>
						</a>
			...
			template:
				...
				<tr>
					<td wid=30% class="text-center" rowspan="9"><img
						:src="detail.poster" style="width: 250px;height:350px"></td>
					<td colspan="2">
						<h3>
							<span id="name">{{detail.name}}</span>&nbsp;<span
								style="color: orange">{{detail.score}}</span>
						</h3>
					</td>
				</tr>
				<tr>
