...
<%--
	...
	1. Vue 객체 생성
	   Vue.createApp({})
	2. Vue에서 필요한 HTML을 제어하는 데이터를 정의
	   data()
	   {
	   		return{
	   			변수 설정
	   ...
	   mounted(){} => HTML이 브라우저에서 실행이 된 상태 
	       ...
	       |       => $(function(){})
	       |       ** 시작과 동시에 데이터 값이 서버에서 데이터 읽기
	       |       ** 다른 프레임워크 연동
	       |       ** Jquery / React / AngularJS
	   updated(){} => data()안에 있는 데이터값이 갱신되면 호출
	       |
	   unmounted(){} => 화면이 변경이 된 경우 => Vue객체 소멸
		...
		<div class="row">
			...
			<table class="table">
				<tr>
					...
					<td width="85%"><input type=text ref="name" size=20
						class="input-sm" v-model="name"></td>
				</tr>
				<tr>
					<th width="15%" class="text-center">제목</th>
					<td width="85%"><input type=text ref="subject" size=45
						class="input-sm" v-model="subject"></td>
				</tr>
				<tr>
					<th width="15%" class="text-center">내용</th>
					<td width="85%"><textarea rows="10" cols="45" ref="content" v-model="content"></textarea>
					</td>
				</tr>
				<tr>
					<th width="15%" class="text-center">비밀번호</th>
					<td width="85%"><input type=password ref="pwd" size=15
