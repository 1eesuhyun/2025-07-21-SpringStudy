       ...
       <tbody>
         ...
         <tr>
           <td colspan="4" class="text-right">
            ...
            <a class="btn btn-xs btn-danger a-link" @click="del()">{{msg}}</a>
            <a href="../board/list.do" class="btn btn-xs btn-info">목록</a>
           </td>
         </tr>
         <tr v-show="isShow">
          <td colspan="4" class="text-right">
           비밀번호:<input type="password" ref="pwd" size="10" class="input-sm" v-model="pwd"><button class="btn-sm btn-danger" @click="boardDelete()">삭제</button>
          </td>
         </tr>
       </tbody>
     </table>
