	...
	<div class="container">
		...
		<div class="row">
			<table class="table">
				...
				<tr>
					<td colspan="4" class="text-right"><a href="update.do?no=${vo.no }"
						class="btn btn-xs btn-warning">수정</a> <a href="#"
						class="btn btn-xs btn-success" @click="btnClick()">{{isOn?'삭제':'취소'}}</a>
						<a href="list.do" class="btn btn-xs btn-info">목록</a></td>
				</tr>
				<tr v-show="bShow">
					<td colspan="4" class="text-right">비밀번호:<input type="password"
						name=pwd size=10 class="input-sm" v-model="pwd" ref="pwdRef">
