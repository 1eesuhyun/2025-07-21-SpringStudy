...
<div class="container">
 ...
 <div class="row">
  ...
  <button type="button" class="btn-sm btn-info" @click="select(2)">중식</button>
  <button type="button" class="btn-sm btn-success" @click="select(3)">일식</button>
  <button type="button" class="btn-sm btn-primary" @click="select(4)">양식</button>
