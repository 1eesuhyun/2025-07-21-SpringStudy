...
public class MainClass {
	public static void main(String[] args) {
		...
		System.out.println("이름:"+s.getHman().getName());
		System.out.println("성별:"+s.getHman().getSex());
		System.out.println("주소:"+s.getHman().getAddress());
		System.out.println("전화:"+s.getHman().getPhone());
	}
}
